...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SAGI Pharmaceutical — a Delhi-based pharmaceutical company delivering research-backed formulations across bone care, gastro, pain, neuro, anti-infectives and nutraceuticals." },
